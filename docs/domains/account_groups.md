...
- **Errores**: `404` si el código no existe. `409` si ya está `accepted` o expirada (transición de estado inválida, no un problema de autorización — por eso `409` y no `403`/`401`).
